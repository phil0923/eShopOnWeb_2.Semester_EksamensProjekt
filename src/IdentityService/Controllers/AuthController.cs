...
namespace IdentityService.Controllers
{
	...
	public class AuthController : ControllerBase
	{
		...
		public AuthController(IConfiguration config, UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IEmailSender emailSender, ILogger<AuthController> logger, AuthService authService, EmailConfirmationService emailConfirmationService)
		{
			_config = config;
